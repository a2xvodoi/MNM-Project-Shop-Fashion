...
const validateRegisterUser = () => {
  return [
    ...
    check("user_name", "Tên đăng nhập phải ít nhất 4 kí tự").isLength({
      min: 4,
    }),
    ...
    check("full_name", "Họ tên phải ít nhất 6 kí tự").isLength({
      min: 6,
    }),
...
const validateInfo = () => {
  return [
    ...
    check("data.user_name", "Tên đăng nhập không được để trống")
      .not()
      .isEmpty(),
    check(
      "data.user_name",
    ...
    check("data.user_name", "Tên đăng nhập phải ít nhất 4 kí tự").isLength({
      min: 4,
    }),
    ...
    check("data.full_name", "Họ tên phải ít nhất 6 kí tự").isLength({
      min: 6,
    }),
    ...
    check("data.birthday", "Ngày sinh không đúng định dạng").isISO8601(
      "yyyy-mm-dd"
    ),
...
const validatePassword = () => {
  return [
    check("data.passwordOld", "Mật khẩu cũ không được để trống")
      .not()
      .isEmpty(),
    check("data.passwordNew", "Mật khẩu mới phải có ít nhất 6 kí tự").isLength({
      min: 6,
    }),
  ];
};
